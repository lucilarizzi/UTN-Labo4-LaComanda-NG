...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.imagenes.push(['../../../assets/CAP-13.png', 'HOLA']);
    this.imagenes.push(['../../../assets/CAP-14.png', 'GATO']);
    this.imagenes.push(['../../../assets/CAP-15.png', 'FINAL']);
    this.imagenes.push(['../../../assets/CAP-16.png', 'VERANO']);
