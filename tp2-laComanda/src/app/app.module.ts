...
import { ViboritaComponent } from './componentes/viborita/viborita.component';
...
import { DinoGameComponent } from './componentes/dino-game/dino-game.component';
...
@NgModule({
  declarations: [
    ...
    ListadoDirectivasComponent, DetalleCuentaComponent, DinoJuegpComponent,
    ListaMesaDirective, AreasPipe, EstadosPipe, ColorPedidoDirective, ElegirMesaComponent, EstadosMesaClientePipe, ColorBadgeAreaDirective, DinoGameComponent
  ],
  imports: [
